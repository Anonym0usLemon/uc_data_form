...
var alwaysInclude = ["80#", "100#", "105#", "UV Coat", "Leather", "Starline", "Velveteen", "Art Cloth", "Photowrap", "Laminate", "Clear Cover", "Frosted Cover", "Sticker", "Protective Seal", "Do not score", "Mounting", "Card Stock", "Metallic", "Texture", "Drymount included.", "Lustre coat included.", "Insert to folders.", "Laminate included.", "Sintra", "Bevel", "Envelopes"];
...
for (var i = 0; (orderOption = orderOptions[i]) != null; i++) {
	...
	if (inArray(highlightOptions, optionLabel)) {
		orderOption.innerHTML = "<span style=\"font-size:larger;\"><b>" + optionLabel + "</b></span>";
	}
